...
| location   | Available only for Multi-Geo tenants. If not specified, jobs are retrieved from all locations in your tenant.  For supported values, refer to [Parameter: location](../overview.md#parameter-location). | string | No |
