...
You must register an app through Elements > API app registration to authenticate and authorize your access to AvePoint Graph API. For details, refer to [App Registration](https://learn.avepoint.com/elements-user-guide/elements-public-apis/app-registration.html)  
