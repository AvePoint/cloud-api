...
Use this API to start a job for restoring the archived data of a Team/Group.
...
This section outlines the HTTP method and endpoint used to start a job for restoring the archived data of a Team/Group.
...
| siteAdministratorUserPrincipalName | The User Principal Name (UPN) of the Microsoft 365 account to assign to the Owner group of the Team or Group being restored. | string | No |
...
```json
{
  ...
  "siteAdministratorUserPrincipalName": "admin@contoso.com", // The User Principal Name (UPN) of the Microsoft 365 account to assign to the Owner group of the Team or Group being restored
}
```
...
```json
{
  ...
  "jobId": "be3693dd-****-****-****-48f71d88dc7e" // The ID of the restore job
}
```
