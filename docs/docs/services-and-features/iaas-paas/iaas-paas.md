...
| serviceType | Sets the service type of the jobs to get.<ul>  <li> **1** for Azure Virtual Machine.</li>  <li> **2** for Microsoft Entra ID.</li><li> **4** for Azure Storage.</li>  <li> **64** for Admin Portal Settings.</li><li> **128** for Common.</li> <li> **256** for Amazon EC2.</li> <li> **512** for Native Azure SQL backup monitoring.</li><li> **1024** for Azure DevOps.</li><li> **2048** for Azure SQL backup.</li><li> **4096** for Azure AD B2C.</li><li> **8192** for Google Cloud Platform.</li><li> **16384** for AWS Setting.</li><li> **20000** for SQL Server.</li><li> **21000** for VMware.</li><li> **23000** for Google Cloud Storage.</li><li> **24000** for Azure Cosmos Database.</li><li> **25000** for Azure PostgreSQL.</li><li> **26000** for Amazon S3.</li><li> **27000** for Entra External ID.</li></ul> | Enum | No |
| jobType |  Sets the job types that you want to get.<ul><li> **1** for Azure Virtual Machine Backup Job.</li><li> **2** for Azure Virtual Machine Restore Job.</li><li> **4** for Azure Virtual Machine File Level Export Job.</li><li> **33** for Azure Virtual Machine Index Generation Job.</li><li> **64** for Data Retention Job.</li><li> **128** for Microsoft Entra ID Backup Job.</li><li> **256** for Microsoft Entra ID Restore Job.</li><li> **257** for Microsoft Entra ID Export Job.</li><li> **1024** for Azure Storage Backup Job.</li><li> **2048** for Azure Storage Restore Job.</li><li> **4096** for Azure Storage Export Job.</li><li> **20003** for Admin Portal Settings Backup Job.</li><li> **20004** for Admin Portal Settings Export Job.</li><li> **20006** for Admin Portal Settings Restore Job.</li><li> **20009** for Amazon EC2 Backup Job.</li><li> **20010** for Amazon EC2 Restore Job.</li><li> **20012** for Native Azure SQL backup monitoring Backup Job.</li><li> **20013** for Native Azure SQL backup monitoring Restore Job.</li><li> **20014** for Azure DevOps Backup Job.</li><li> **20015** for Azure DevOps Restore Job.</li><li> **20016** for Azure SQL Database Backup Job. Note that this API does not support the native Azure SQL Backup Monitoring jobs.</li><li> **20017** for Azure SQL Database Restore Job. Note that this API does not support retrieving the restore jobs of using native Azure SQL Backup.</li><li> **20018** for Azure VM File Restore Job.</li><li> **20019** for Azure AD B2C Backup Job.</li><li> **20020** for Azure AD B2C Restore Job.</li><li> **20022** for Google VM instance Backup Job.</li><li> **20023** for Google VM instance Restore Job.</li><li> **20024** for Google VM instance Generate Index Job.</li><li> **20025** for Google VM instance File Level Export Job.</li><li> **30003** for Data Deletion Job.</li><li> **40000** for AWS Platform Configurations Backup job.</li><li> **40001** for AWS Platform Configurations job.</li><li> **60000** for SQL Server Backup Job.</li><li> **60001** for SQL Server Restore Job.</li><li> **60010** for Azure VMware Virtual machines Backup Job.</li><li> **60011** for Azure VMware Virtual machines Restore Job.</li><li> **60100** for Azure PostgresSQL Backup Job.</li><li> **60101** for Azure PostgresSQL Restore Job.</li><li> **70010** for Google Cloud Storage Backup Job.</li><li> **70011** for Google Cloud Storage Restore Job.</li><li> **70012** for Google Cloud Storage Export Job.</li><li> **80000** for Azure Cosmos Database Backup Job.</li><li> **80010** for Azure Cosmos Database Restore Job.</li><li> **90000** for Entra External ID Backup Job.</li><li> **90001** for Entra External ID Restore Job.</li><li> **90002** for Entra External ID Export Job.</li><li> **90110** for Amazon S3 Backup Job.</li><li> **90120** for Amazon S3 Restore Job.</li></ul> | enum | No |
