...
| serviceType | Sets the service type of the jobs to get.<ul>  <li> **1** for VM</li>  <li> **2** for AAD</li><li> **4** for AzureFile</li>  <li> **64** for APSetting</li><li> **128** for Common</li> <li> **512** for AzureSQL</li><li> **1024** for AzureDevOps</li></ul> | No | Enum |
| jobType |  Sets the job types that you want to get.<ul><li> **1** for Backup</li><li> **2** for Restore</li><li> **4** for Export</li><li> **32** for GenIndex</li><li> **64** for Retention</li><li> **128** for AADBackup</li><li> **256** for AADRestore</li><li> **257** for AADExport</li><li> **1024** for FileBackup</li><li> **2048** for FileRestore</li><li> **4096** for FileExport</li><li> **20003** for APSettingBackup</li><li> **20004** for APSettingExport</li><li> **20006** for APSettingRestore</li><li> **20012** for SQLBackup</li><li> **20013** for SQLRestore</li><li> **20014** for DevOpsBackup</li><li> **20015** for DevOpsRestore</li></ul> | No | Enum |
