...
|---|---|---|---|
|pageIndex|Sets the starting number of the page to get the jobs. The default value is 1.|integer|Yes|
|pageSize|Sets the number of jobs to display on one page. The default value is 10.|integer|Yes|
...
|--------------------|-----------------------------------------------------------------------|--------|
| totalCount      | Total number of jobs matching the query parameters.                   | int    | 
| jobs             | A list containing job objects with detailed information.              | Array  | 
