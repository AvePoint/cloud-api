...
|startTime|Sets a start time (UTC time) for the time range in ISO 8601 format.|long|Yes|
|finishTime|Sets an end time (UTC time) for the time range in ISO 8601 format.|long|Yes|
