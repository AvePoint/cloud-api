...
|--------------------|-----------------------------------------------------------------------|--------|
| totalNumber        | Total number of jobs matching the query parameters.                   | int    | 
| result             | A list containing job objects with detailed information.              | Array  | 
| module             | The module associated with the job.                                   | string | 
| type               | The type of job performed.     | string |
...
| successfulEntity   | Number of entities successfully processed.                            | int    | 
| failedEntity       | Number of entities with errors.                            | int    | 
| skippedEntity      | Number of entities skipped during processing.                         | int    | 
| warningEntity      | Number of entities with warnings.                                     | int    | 
| totalEntity        | Total number of entities involved in the job.                         | int    | 
| successfulRecord   | Number of records successfully processed.                             | int    |
| failedRecord       | Number of records with errors.                             | int    | 
| skippedRecord      | Number of records skipped during processing.                          | int    | 
| warningRecord      | Number of records with warnings.                                      | int    | 
| totalRecord        | Total number of records involved in the job.                          | int    | 
...
```json
https://graph-us.avepointonlineservices.com/dynamicsbackup/jobs?pageIndex=1&pageSize=5&startTime=2021-05-22T11:42:00Z&endTime=2024-09-22T11:42:00Z&type=1&status=3&organizationId=69cb1ecc-f8e8-439b-8077-a4b7fd45e87f
...
```json
{
    "totalNumber": 20, // Total number of jobs.
    "nextLink": "/jobs?pageIndex=2&pageSize=5&startTime=2021-05-22T11:42:00Z&endTime=2024-09-22T11:42:00Z&type=1&status=3&organizationId=6cccccc-ffff-bbb-88888-aabbccdeee", //
    "result": [
        {
