# Update Office Information of a Cloud User

Use this API to update the office information of a cloud user in a customer's tenant. 
...
information of a cloud user in a cutomer's tenant.

| Method | Endpoint | Description |
|-----------|--------|------------|
| PUT | `/partner/external/v3/um/customers/{customerId}/tenants/{tenantId}/users/{userId}/office` | Updates the office information of a cloud user in a customer's tenant.|

## URL Parameters

This section describes the query parameters that can be added to the URL when sending a PUT request, allowing you to update the office information of a cloud user according to your specific requirements and preferences.
...
```json
{
  ...
  "department": "Department A", // The department of the user
  "location": "ABC New Street" // The location of the user
}
```