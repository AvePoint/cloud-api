# Update Manager of a User

Use this API to update the manager of a user in a customer's tenant. 
...
This section outlines the details of the HTTP method and endpoint used to update the manager of a user in a customer's tenant.

| Method | Endpoint | Description |
|-----------|--------|------------|
| PUT | `/partner/external/v3/um/customers/{customerId}/tenants/{tenantId}/users/{userId}/manager` | Updates the manager of a user in a customer's tenant.|
