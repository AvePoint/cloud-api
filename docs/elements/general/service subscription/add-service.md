...
|licenseItems.Resource               |The resource of the service.   <ul><li>**Microsoft 365 pool** - Office365Backup</li><li>**PowerPlatform pool** - Office365PPBackup</li><li>**Exchange Online & OneDrive pool** - Office365EXODBackup</li><li>**Baseline management pool** - PartnerTenantSettingManagement</li><li>**Workspace management pool** - PartnerWorkspaceOnboarding</li><li>**PartnerUserManagement pool** - PartnerTenantSettingManagement</li><li>**Workspace management - Storage optimization pool** - PartnerStorageOptimization</li></ul>                      |string      |Yes|
