...
|-----------|--------|------------|
| POST | `/partner/external/v3/general/customers/{customerId}/avpt-products/cloud-backup-m365/jobs/batch` | Retrieve the job details of the backup services for a specific customer.|
...
| Parameter | Description | Type | Required |
| --- | --- | --- | --- |
| jobType | The type of the job to be retrieved. | integer | No |
...
```json
https://graph.avepointonlineservices.com/partner/external/v3/general/customers/caf9****-2cc6-****-b04b-794c****5ea3/avpt-products/cloud-backup-m365/jobs/batch
```
    ...
    "data": [
        {
            ...
            "status": 3, // The status of the job. 3 - Failed
