...
| API | Permission |
| ------------------------------------ | ---------------------------------------------------------- |
| `partner/external/v3/general/customers/{customerId}/tenants/{tenantId}/product/{productName}/apps` | elements.customers.read.all |
...
| ------ | -------------------------------------- | -------------------------------------- |
| GET    | `partner/external/v3/general/customers/{customerId}/tenants/{tenantId}/product/{productName}/apps` | Retrieves the status of a service app for a Microsoft 365 tenant. |
...
| ------------------------- | -------------------------- | ----- |
| isConsent | Indicates whether the service app for the Microsoft 365 tenant has been authorized. <ul><li>**false** - The service app for the Microsoft 365 tenant does not exist </li><li>**true** - The service app for the Microsoft 365 tenant has already been authorized</li></ul> | bool |
...
[
  {
    "isConsent": false // Indicates whether the service app for the Microsoft 365 tenant has been authorized
  }
]
```
