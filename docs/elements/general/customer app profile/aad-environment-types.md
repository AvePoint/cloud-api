# AAD Environment Types

The following table lists the Azure Active Directory (AAD) environment types along with their corresponding enumeration values and descriptions.
